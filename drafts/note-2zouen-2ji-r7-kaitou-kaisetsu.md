...
- **問題1**：施工管理（高木植栽・支柱・施肥・高木移植・地被類植栽）
...
- **(c) 釘打ち（くぎ打ち）**（丸太同士の結合は釘打ちのうえ結束する）
- **(d) 鉄線**（丸太と丸太は釘打ち＋鉄線がらみで結束する）
- **(e) 〇**（丸太は末口を下にして打ち込む）
...
- 施肥は**基肥（元肥）＋追肥**に大別。基肥は**遅効性肥料**（ゆっくり長く効く）。確実な定番。
...
- **(ハ)** 環状剥皮は、残した**支持根**の先端への同化養分の流れを止め、剥皮部の上に養分を蓄積させて発根を促す。
