...
const EXAM_META: Record<string, ExamMeta> = {
  ...
  "2doboku": {
    ...
    overview:
      "2級土木施工管理技士は、主任技術者として土木工事の現場を担当できる国家資格です。1級のステップアップ前提で取得する方が多く、17歳以上から受験できる「第一次検定のみ」の新制度により受験者数が増加傾向。前期（6月）・後期（10月）の年2回チャンスがあります。",
    ...
    books: [
      ...
      },
      {
        ...
        comment: "土木未経験者・初心者向けの入門マンガ。筆者も実際に読んだ1冊。最新試験範囲には未対応のため『試験対策本の前に読む入門書』として活用を。",
      },
    ],
    schoolSlug: "school-hikaku-doboku",
  ...
  "2zou": {
    ...
    overview:
      "2級造園施工管理技士は、造園工事の主任技術者として中小規模の現場を担当できる国家資格です。庭園・公園・緑化工事の現場監督に必須レベルの資格で、1級へのステップとしても最適。17歳以上から第一次検定のみ受験できる新制度で、受験者数が増えています。",
