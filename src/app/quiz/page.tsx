...
export const metadata: Metadata = {
  ...
  description:
    "1級・2級 土木/造園施工管理技士の過去問を4択Webクイズで無料演習。R4〜R8年度の本試験問題を収録、解説付きで苦手分野を見える化。スマホでスキマ時間に学習できる独学合格者向けの無料問題集です。",
  alternates: {
    canonical: "/quiz",
  },
  openGraph: {
    ...
    description:
      "1級・2級 土木/造園施工管理技士の過去問を4択Webクイズで演習。R4〜R8年度別過去問モード（1,100問超）搭載。スマホ対応・解説付き・完全無料。",
    url: "/quiz",
  },
...
const quizFaqs = [
  ...
  {
    q: "どの年度の過去問が出題されますか？",
    a: "令和4年度〜令和8年度（R4〜R8）の本試験問題を収録しています（R8は2級土木・2級造園の前期分）。1級土木・2級土木・1級造園・2級造園の4区分に対応。第一次検定の過去問を中心に、類題も多数含まれています。",
  },
  {
    q: "解答後に解説は表示されますか？",
    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <section className="mb-8 bg-white border border-border rounded-xl p-5 md:p-6 shadow-sm">
        ...
        <ul className="space-y-3 text-sm text-gray-700">
          ...
          <li className="flex gap-2">
            <FiCheckCircle size={18} className="text-primary flex-shrink-0 mt-0.5" />
            <div><strong>R4〜R8年度の本試験問題を収録</strong>：最新の出題傾向を反映した合計1,100問超。</div>
          </li>
          <li className="flex gap-2">
            <FiCheckCircle size={18} className="text-primary flex-shrink-0 mt-0.5" />
