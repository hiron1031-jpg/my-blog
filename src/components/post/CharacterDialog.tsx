    ...
    <div className="not-prose my-6 space-y-3 rounded-xl border border-border bg-surface p-4">
      ...
      <div className="flex items-start gap-3">
        <div className="shrink-0">
          ...
          />
          <p className="mt-1 text-center text-xs text-secondary">初心者</p>
        </div>
        <div className="relative mt-1 rounded-2xl rounded-tl-none bg-white px-4 py-3 text-base text-secondary shadow-sm border border-border max-w-[80%]">
      ...
      <div className="flex items-start justify-end gap-3">
        <div className="relative mt-1 rounded-2xl rounded-tr-none bg-primary/10 px-4 py-3 text-base text-secondary shadow-sm border border-primary/20 max-w-[80%]">
        ...
        <div className="shrink-0">
          <Image
            ...
            className="rounded-full border border-border"
          />
          <p className="mt-1 text-center text-xs text-secondary">ビーバー監督</p>
        </div>
      </div>
    </div>
  );
